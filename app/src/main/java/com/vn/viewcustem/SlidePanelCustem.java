...
public class SlidePanelCustem extends ViewGroup {
    private static final String TAG = "SlidePanelCustem";
    ...
    public SlidePanelCustem(Context context) {
        this(context, null);
    }

    public SlidePanelCustem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidePanelCustem(Context context, AttributeSet attrs, int defStyle) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SlidePanelCustem parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        @Override
        public void invalidateChildRegion(SlidePanelCustem parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SlidePanelCustem.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SlidePanelCustem.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SlidePanelCustem.this) {
